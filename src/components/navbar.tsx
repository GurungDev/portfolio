      ...
      <div className="fixed z-[1000] top-0 w-full py-3">
        <div className="flex justify-between app-layout">
          <div className="group relative ">
            ...
            <div className="w-[0vw] h-[0vh] group-hover:w-[5.3vw] rounded-[2px] group-hover:h-[6vh] duration-500 -left-2 top-0 absolute z-[-5] bg-red-400"></div>
          ...
          <div className="relative group/icon     bg-red-400 rounded-full p-2">
            <FaPlus
              size={40}
              className="group-hover/icon:rotate-90 duration-500 text-neutral-100"
            />
            <div className="absolute left-1/2  transform group-hover/icon:-translate-x-1/2 delay-1000 group-hover/icon:delay-0 translate-x-1/2 top-20 w-[300px] bg-red-400 px-5 py-4 rounded-md shadow-lg  duration-500">
            <ul>
  <li className="py-[.5]">
